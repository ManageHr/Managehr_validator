...
Característica: Gestión de contratos
  ...
  Escenario: Registrar un nuevo contrato
    ...
    Y registra un nuevo contrato en el módulo de contratos
      ...
      | 12345678990 | Contrato a término fijo | Activo | 01/05/2024   | 01/05/2025   | Finanzas | Empleado | contratoDemo.pdf |
    Entonces el contrato con documento "12345678990" debe quedar registrado en la tabla de contratos
