...
public class ContratosPage extends PageObject {
    ...
    public static final Target CAMPO_BUSQUEDA = Target.the("Campo de búsqueda")
            .located(By.xpath("//input[contains(@placeholder,'Buscar')]"));

    public static final Target TODOS_ENLACES_MENU = Target.the("Todos los enlaces del menú")
            .located(By.xpath("//nav[@class='nav']//a[contains(@class,'nav-link')]"));
}
